...
export default function index() {
  ...
  const arrayProduct = [
    {
      ...
      content:
        "Broadway Returns by Mushq Embroidered Khaddar Suits Unstitched 3 Piece MQ22BR MW22-06 Deniz - Winter Collection",
    },

    {
      ...
      content:
        "Broadway Returns by Mushq Embroidered Khaddar Suits Unstitched 3 Piece MQ22BR MW22-04 Nur - Winter Collection",
    },
    {
      id: 3,
      name: "brand-2",
  ...
  return (
    <div className="w-[80%] border-4  p-2 bg-white  rounded-lg py-5">
      <h5 className=" text-base  font-Montserrat capitalize mb-2 text-black font-semibold">
        Sales and Discounts{" "}
      </h5>
      <div className="w-[10%] border-t-4 rounded-lg  border-pink-600"></div>
