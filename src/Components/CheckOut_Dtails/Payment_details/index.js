...
export default function index({ setState }) {
  return (
    ...
    <div className=" w-1/2  bg-white p-8 my-8 mx-auto rounded-2xl shadow-lg">
      ...
      <div className=' p-3'>
        <Radion_button label={"Standard Shipping Rs. 100.00"} type={'radio'} />
        <Radion_button label={"Standard Shipping + 'Treatment for All' with Indus (Rs.150) Rs. 250.00"} type={'radio'} />
      </div>
      <Lable_button text={"3 Payment Method"} />
      <div className='border-dashed border-b border-indigo-600 p-3'>
        <Radion_button label={"VISA / MASTER CARD"} type={'radio'} radio_img={'images/payment.png'} className={" border"} />
      </div>
      <div className='border-dashed border-b border-indigo-600 p-3'>
        <Radion_button label={"CASH ON DELIVERY"} type={'radio'} radio_img={'images/payment.png'} className={" border"} />
      </div>
      <div className='border-dashed border-b border-indigo-600 p-3'>
        <Radion_button label={"BANK TRANSFER"} type={'radio'} radio_img={'images/payment.png'} className={" border"} />
      </div>
